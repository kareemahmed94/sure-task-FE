<template>
  ...
  >
    ...
    <div class="text-danger">
      NOTE: This demo uses a public API to simulate realistic flow. The database is reset every 30 minutes and otherwise
      reveals no sensitive data such as emails or last names.

      <br/>

      NOTE: Would be nice to get some generic node (or deno?) service up for better/safer local testing. If you anyone
